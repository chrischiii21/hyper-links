...
import { Upload, Clipboard, Check, FileText, Loader2, LayoutGrid, Trash2, Plus, ChevronUp } from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto px-4 space-y-8">
      ...
      <header className="mb-10 flex flex-col items-center text-center space-y-4">
        <h1 className="text-5xl font-black tracking-tighter text-slate-900 leading-tight">
          File <span className="text-indigo-600">Ingestion</span>
        </h1>
        <p className="text-slate-500 font-medium max-w-lg mx-auto leading-relaxed">Drop a research report to automatically segment it into the standard sections.</p>
      </header>
